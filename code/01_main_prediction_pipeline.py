...
CSV_PATH   = r"F:\delirium_model_v2.csv"
CSV_FULL   = r"F:\delirium_model_full.csv"
...
# >50% missing — too sparse for imputation
DROP_HIGH_MISSING = ['albumin_min', 'bilirubin_max', 'alt_max']
...
EXCLUDE_COLS = set(
    ID_COLS + OUTCOME_COLS + CAM_META_COLS + DROP_HIGH_MISSING + LEAKAGE_COLS
)
...
try:
    ...
    print(f"Full cohort N={len(y_full):,} (includes repeat ICU stays)")
